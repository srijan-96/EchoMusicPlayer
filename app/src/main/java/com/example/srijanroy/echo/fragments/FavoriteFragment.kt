...
import com.example.srijanroy.echo.adapters.FavoriteAdapter
...
class FavoriteFragment : Fragment() {
    ...
    var nowPlayingBottomVar: RelativeLayout? = null
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        nowPlayingBottomVar = view?.findViewById(R.id.hiddenBarFavScreen)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        display_favorites_by_searchinf()
        bottomBarSetup()
    ...
    fun bottomBarSetup() {
        ...
        try {
            ...
            if (SongPlayingFragment.Statified.mediaPlayer?.isPlaying as Boolean) {
                nowPlayingBottomVar?.visibility = View.VISIBLE
            } else {
                nowPlayingBottomVar?.visibility = View.INVISIBLE
            }
    ...
    fun bottomBarClickHandler() {
        ...
        nowPlayingBottomVar?.setOnClickListener({
    ...
    fun display_favorites_by_searchinf() {
